      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-md mx-auto space-y-4 mb-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-500 dark:text-gray-400 text-sm">or join existing</span>
            <div className="flex-1 h-px bg-gray-300 dark:bg-gray-600"></div>
          </div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-center font-mono"
            />
            <button 
              onClick={joinRoom}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">No registration required. Create and join rooms instantly.</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Remote Friendly</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Perfect for distributed teams. Up to 4 participants per room.</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Consensus Building</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Reveal votes simultaneously and celebrate team alignment.</p>
          </div>
        </div>
      </div>
    </div>
